...
<form action="video-update" method="post">
  <div class="container w-50 mt-5">
    <h2 class="d-flex justify-content-center mb-4">Edit Video</h2>
    ...
    <div class="row align-items-center mt-2">
      ...
      <div class="col-10">
        <input type="text" class="form-control col-8" name="id" value="${currentVideo.id}" readonly>
      </div>
    </div>
    <div class="row align-items-center mt-2">
      <div class="col-2">
    ...
    <div class="row align-items-center mt-2">
      <div class="col-2">
        <label for="" class="fw-bold">Admin:</label>
      </div>
      <div class="col-1">
